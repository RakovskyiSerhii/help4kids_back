...
SET @cat1 = UUID();
INSERT INTO service_categories (id, name, iconUrl, featured, created_at, updated_at)
VALUES (@cat1, 'Консультативні прийоми лікарів-педіатрів в медичному центрі', 'ic_stethoscope.svg', TRUE, NOW(), NOW());
...
SET @cat2 = UUID();
INSERT INTO service_categories (id, name, iconUrl, featured, created_at, updated_at)
VALUES (@cat2, 'Гінекологія', 'ic_gynecology.svg', TRUE, NOW(), NOW());

INSERT INTO services (id, category_id, title, price, booking_id, created_at, updated_at)
VALUES 
(UUID(), @cat2, 'Консультація гінеколога', '{"price":600}', 's12967394', NOW(), NOW()),
(UUID(), @cat2, 'Консультауія гінеколога по вагітності (для дівчат у нас на обліку)', '{"price":500}', 's12967398', NOW(), NOW()),
(UUID(), @cat2, 'УЗД органів малого тазу', '{"price":500}', 's12967400', NOW(), NOW()),
(UUID(), @cat2, 'Кольпоскопія', '{"price":400}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'ПАП-тест класичний (мазок на склі)', '{"price":300}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'ПАП-тест на основі рідинної цтології', '{"price":700}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'Консультація+УЗД', '{"price":950}', 's12967415', NOW(), NOW()),
(UUID(), @cat2, 'Забір матеріалу на мікрофлору', '{"price":300}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'Ph-метрія', '{"price":100}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'Введення ВМС', '{"price":800}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'Видалення ВМС', '{"price":600}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'Конізація шийки матки', '{"price":2500}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'Діагностичне вишкрібання порожнини матки', '{"price":2900}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'Поліпектомія', '{"price":1200}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'Введення маточного кільця', '{"price":350}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'Роз''єднання синехій', '{"price":900}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'Пайпель біопсія', '{"price":1500}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'Медикаментозне переривання вагітності', '{"price":3500}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'Вакуум аспірація шприцем', '{"price":2800}', NULL, NOW(), NOW()),
(UUID(), @cat2, 'Постановка на облік по вагітності', '{"price":3000}', NULL, NOW(), NOW());
...
SET @cat7 = UUID();
INSERT INTO service_categories (id, name, iconUrl, featured, created_at, updated_at)
VALUES (@cat7, 'Дерматолог', 'ic_skin.svg', TRUE, NOW(), NOW());
...
SET @cat9 = UUID();
INSERT INTO service_categories (id, name, iconUrl, featured, created_at, updated_at)
VALUES (@cat9, 'УЗД діагностика', 'ic_monitor.svg', TRUE, NOW(), NOW());
...
INSERT INTO services (id, category_id, title, short_description, price, duration, booking_id, created_at, updated_at)
VALUES 
(UUID(), @cat10, 'Медогляд (довідка 086/о)', 'При собі потрібно мати форму 063 або фото щеплень за віком або паспорт вакцинації; Огляд включає: оцінку стану здоров''я, вимірювання зросту і ваги, перевірка зору, слуху, постави, рекомендації по аналізам та подальшим щепленням за потреби.', '{"price":1000}', NULL, 's12965626', NOW(), NOW()),
(UUID(), @cat10, 'Оформлення довідки в басейн', 'тільки за умови огляду дитини педіатром; Попередньо слід здати кал на яйця глистів або зішкріб на ентеробіоз в будь-якій лабораторії і з результатами записатися на прийом до нас', '{"price":0, "customPriceString":"безкоштовно"}', NULL, 's12965630', NOW(), NOW()),
(UUID(), @cat10, 'Оформлення довідки 063/о (про щеплення)', 'при проведенні трьох і більше щеплень в медцентрі - безкоштовно', '{"price":300}', NULL, 's12965633', NOW(), NOW()),
(UUID(), @cat10, 'Оформлення довідки 063 про щеплення на англ. мові', NULL, '{"price":600}', NULL, NULL, NOW(), NOW()),
(UUID(), @cat10, 'Оформлення міжнародного паспорту вакцинації з перенесенням попередніх вакцин', 'при проведенні першої вакцинації в нашому МЦ - безкоштовно', '{"price":500}', NULL, NULL, NOW(), NOW()),
(UUID(), @cat10, 'Довідка про епідоточення (після хвороби)', 'за умови спостереження лікарем медичного центру під час хвороби', '{"price":0, "customPriceString":"безкоштовно"}', NULL, 's12980901', NOW(), NOW()),
(UUID(), @cat10, 'Довідка 079 в дтячий табір', 'при огляді дитини на консультації', '{"price":0, "customPriceString":"безкоштовно"}', NULL, 's12965639', NOW(), NOW());
...
INSERT INTO services (id, category_id, title, short_description, price, duration, booking_id, created_at, updated_at)
VALUES 
(UUID(), @cat17, 'Прокол вух', NULL, '{"price":800}', NULL, 's12967371', NOW(), NOW()),
(UUID(), @cat17, 'Прокол 1 вуха', NULL, '{"price":500}', NULL, NULL, NOW(), NOW()),
(UUID(), @cat17, 'Сережки', NULL, '{"price":0, "customPriceString":"від 500"}', NULL, NULL, NOW(), NOW());

-- Category 18: Вакцинація
SET @cat18 = UUID();
INSERT INTO service_categories (id, name, iconUrl, featured, created_at, updated_at)
VALUES (@cat18, 'Вакцинація', 'ic_syringe.svg', TRUE, NOW(), NOW());

INSERT INTO services (id, category_id, title, short_description, price, duration, booking_id, created_at, updated_at)
VALUES 
(UUID(), @cat18, 'Гексаксим АаКДП+ІПВ+ХІБ+гепВ (Франція) (правець, дифтерія, кашлюк, поліоміеліт, гепатит В, гемофільна інфекція) до 2х років', NULL, '{"price":2400}', NULL, 's12965643', NOW(), NOW()),
(UUID(), @cat18, 'Інфанрикс Гекса АаКДП+ІПВ+ХІБ+гепВ (Бельгія) (правець, дифтерія, кашлюк, поліоміеліт, гепатит В, гемофільна інфекція) до 36 місяців', NULL, '{"price":2600}', NULL, 's12965645', NOW(), NOW()),
(UUID(), @cat18, 'Пентаксим АаКДП+ІПВ+ХІБ (Франція) (правець, дифтерія, кашлюк, поліоміеліт, гемофільна інфекція) до 4 років 11 міс', NULL, '{"price":2200}', NULL, 's12965646', NOW(), NOW()),
(UUID(), @cat18, 'Інфанрикс ІПВ ХІБ АаКДП+ІПВ+ХІБ  (Бельгія) (правець, дифтерія, кашлюк, поліоміеліт, гемофільна інфекція) до 3х років', NULL, '{"price":2400}', NULL, 's12965649', NOW(), NOW()),
(UUID(), @cat18, 'Бустрикс Поліо АаКДП+ІПВ (Бельгія) (правець, дифтерія, кашлюк + поліоміеліт) (з 3 років)', NULL, '{"price":1900}', NULL, 's12965650', NOW(), NOW()),
(UUID(), @cat18, 'Тетраксим АаКДП+ІПВ (Франція) (правець, дифтерія, кашлюк + поліоміеліт) до 6 років 11 місяц', NULL, '{"price":2000}', NULL, 's12965654', NOW(), NOW()),
(UUID(), @cat18, 'Інфанрикс ІПВ АаКДП+ІПВ (Бельгія) (правець, дифтерія, кашлюк + поліоміеліт) до 13 років', NULL, '{"price":2100}', NULL, 's12965655', NOW(), NOW()),
(UUID(), @cat18, 'Бустрикс (Бельгія) (правець, дифтерія, кашлюк)', NULL, '{"price":1700}', NULL, 's12965657', NOW(), NOW()),
(UUID(), @cat18, 'Інфанрикс АаКДП (Бельгія) (правець, дифтерія, кашлюк) до 6 років 11 місяців', NULL, '{"price":1700}', NULL, 's12965658', NOW(), NOW()),
(UUID(), @cat18, 'Пріорикс (Бельгія) (кір, паротит, краснуха)', NULL, '{"price":1700}', NULL, 's12965659', NOW(), NOW()),
(UUID(), @cat18, 'М-М-РВАКСПРО (США) (кір, паротит, краснуха)', NULL, '{"price":0}', NULL, NULL, NOW(), NOW()),
(UUID(), @cat18, 'Ротарикс (Бельгія) (3 штами / 2 дози до 5,5 місяців)', NULL, '{"price":1800}', NULL, 's12965660', NOW(), NOW()),
(UUID(), @cat18, 'Ротатек (США)  (5 штамів / 3 дози до 8 місяців)', NULL, '{"price":2000}', NULL, NULL, NOW(), NOW()),
(UUID(), @cat18, 'Менактра (США) (менінгокок)', NULL, '{"price":0}', NULL, 's12965663', NOW(), NOW()),
(UUID(), @cat18, 'Німенрикс (Бельгія) (менінгокок)', NULL, '{"price":2700}', NULL, 's12965662', NOW(), NOW()),
(UUID(), @cat18, 'Бексеро () (менінгокок В)', NULL, '{"price":4750}', NULL, 's12965664', NOW(), NOW()),
(UUID(), @cat18, 'Синфлорикс (Бельгія) (пневмокок 10 серотипів)', NULL, '{"price":2500}', NULL, 's12965667', NOW(), NOW()),
(UUID(), @cat18, 'Превенар 13 (Великобританія) (пневмокок 13 серотипів)', NULL, '{"price":3700}', NULL, 's12965669', NOW(), NOW()),
(UUID(), @cat18, 'Ваксньюванс (Нідерланди) (пневмокок 15 серотипів)', NULL, '{"price":3650}', NULL, 's12965671', NOW(), NOW()),
(UUID(), @cat18, 'Церварикс (Бельгія) (папіломавірус 16 і 18 типів)', NULL, '{"price":2500}', NULL, 's12971351', NOW(), NOW()),
(UUID(), @cat18, 'Гардасил (США) (папіломавірус 6, 11, 16 і 18 типів)', NULL, '{"price":6100}', NULL, 's12971356', NOW(), NOW()),
(UUID(), @cat18, 'Гардасил 9', NULL, '{"price":6800}', NULL, 's12971369', NOW(), NOW()),
(UUID(), @cat18, 'Хаврикс 720 (Бельгія) (гепатит А)', NULL, '{"price":1700}', NULL, 's12965677', NOW(), NOW()),
(UUID(), @cat18, 'Хаврикс 1440(Бельгія) (гепатит А)', NULL, '{"price":1800}', NULL, 's12965676', NOW(), NOW()),
(UUID(), @cat18, 'Твінрикс (Бельгія) (гепатит А+В)', NULL, '{"price":2400}', NULL, 's12965678', NOW(), NOW()),
(UUID(), @cat18, 'Енджерикс дитячий 0,5мл', NULL, '{"price":1100}', NULL, 's12965679', NOW(), NOW()),
(UUID(), @cat18, 'Енджерикс дорослий 1мл', NULL, '{"price":1250}', NULL, 's12965680', NOW(), NOW()),
(UUID(), @cat18, 'Хіберікс (Бельгія) (гемофільна інфекція)', NULL, '{"price":0}', NULL, NULL, NOW(), NOW()),
(UUID(), @cat18, 'Варілрикс (Бельгія) (вітряна віспа)', NULL, '{"price":2500}', NULL, 's12965673', NOW(), NOW()),
(UUID(), @cat18, 'Варівакс (США) (вітряна віспа)', NULL, '{"price":4000}', NULL, 's12965675', NOW(), NOW()),
(UUID(), @cat18, 'Ваксігрип (Франція)', NULL, '{"price":0}', NULL, NULL, NOW(), NOW()),
(UUID(), @cat18, 'Джи Сі Флю Квадрівалент (Корея)', NULL, '{"price":950}', NULL, 's12965682', NOW(), NOW());
...
INSERT INTO services (id, category_id, title, short_description, price, duration, booking_id, created_at, updated_at)
VALUES 
(UUID(), @cat19, 'Послуга вакцинації вакциною, придбаною особисто', NULL, '{"price":0, "customPriceString":"Вартість консультації лікаря + 100 грн введення внутрішньом''язової ін''єкції.За наявності чеку з аптеки та сертифікату на вакцину, а також за умови доставки вакцини з виконанням вимог холодового ланцюга."}', NULL, 's12965685', NOW(), NOW());
...
(
  UUID(),
  'ОНЛАЙН консультація з питань дитячого сну',
  'Консультація проходить в режимі аудіо або відео зв''язку. У вартість входить попередня оцінка анкети і супровід протягом тижня після консультації (відповіді на письмові запитання).',
  'Якщо ваша дитина має проблеми зі сном – запишіться на онлайн консультацію з питань дитячого сну і ви отримаєте професійну допомогу та відповіді на всі ваші запитання.',
  2500,
  FALSE,
  0,
  '1 година 30 хвилин',
  ...
  'https://secure.wayforpay.com/button/b14f6d3e4d8fc',
  's12964230',
  NOW(),
  NOW()
),
(
  UUID(),
  'Розширена консультація ОНЛАЙН',
  'З питань харчування, закрепів, розвитку дитини, догляду за новонародженими, коли є довга історія хвороби або накопичилось багато різних питань.',
  'Якщо у вас є багато питань або складна ситуація – запишіться на розширену онлайн консультацію. Ви отримаєте детальні відповіді на всі ваші запитання.',
  1500,
  FALSE,
  0,
  '1 година',
  '["Як правильно та безпечно ввести прикорм?", "Як покращити апетит дитині?", "Як привчити дитину до здорового харчування?", "Що робити при закрепах?", "Як зрозуміти, чи нормально розвинута ваша дитина?", "Як доглядати за новонародженим?"]',
  'https://secure.wayforpay.com/button/b5709e2eb20be',
  's12995463',
  NOW(),
  NOW()
),
(
  UUID(),
  'Коротка консультація ОНЛАЙН',
  'Питання по гострій хворобі, висипам, оцінці лабораторних обстежень, уточнюючі з будь-яких питань. Консультація проходить в режимі аудіо зв''язку або переписка в месенджері.',
  'Якщо у вас є конкретне питання або потрібна швидка консультація – замовте коротку онлайн консультацію. Ви отримаєте відповідь на ваше питання.',
  800,
  FALSE,
  0,
  '30 хвилин',
  '["Що робити при гострому захворюванні?", "Як знизити температуру?", "Що робити, коли в дитини блювання та пронос?", "Що означають результати аналізів вашої дитини?", "Як розпізнати висипання?", "До якого спеціаліста звернутись з вашою проблемою?"]',
  'https://secure.wayforpay.com/button/b985e66f07032',
  's12995457',
  NOW(),
  NOW()
);
